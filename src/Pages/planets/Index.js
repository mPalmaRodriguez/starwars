    ...
    <div>
      ...
      <div className="container d-flex   justify-content-center align-items-center">
        <button style={{ display: "contents" }} onClick={disminuir}>
          <BsArrowLeftCircleFill size={20} style={{color:"black", marginRight:"2px",marginTop:"1px"}}/>Anterior
        </button>
        <b style={{marginLeft:"12px", marginRight:"12px",fontSize:"larger", color:"black", textShadow:"0 0 4px #FFE919"}}>{Contador}</b>
        <button style={{ display: "contents" }} onClick={aumentar}>Siguiente
          <BsArrowRightCircleFill size={20} style={{color:"black", marginLeft:"2px",marginTop:"1px"}} /> 
        </button>
      </div>
    </div>
  );
